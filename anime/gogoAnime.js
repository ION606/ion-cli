...
import {generateQuery, askUserQuery} from './userQuery.js';
import downloadStream from './downloadVideo.js';


export default async function getGogo(id, episode = null) {
    var url = `https://api.consumet.org/anime/gogoanime/info/${id}`;
    try {
        ...
        url = `https://api.consumet.org/anime/gogoanime/watch/${episodeData.id}`; //?server={serverName}`
